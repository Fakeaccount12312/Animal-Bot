...
print("Leafman bot started at " + datetime.now().strftime("the %d.%m.%y at %H:%M:%S"))
...
async def on_message(message):
    ...
    if message.author == client.user:
        return
    if msg.startswith('-') and message.channel.name == "bot-spam":
        msg = msg[1:]
        if msg == "help animals":
        ...
        elif msg in synonyms and synonyms[msg[1:]] in data:
        ...
        elif msg == "-pdate" and message.author.name == "Fakeaccount1231":
